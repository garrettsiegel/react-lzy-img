    ...
    <footer className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-gray-300 py-16">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="hover:text-white transition-all duration-300 hover:scale-110 font-medium"
              >
                GitHub
              </a>
              <a
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 hover:text-white transition-all duration-300 hover:translate-x-1"
                >
        ...
        <div className="border-t border-gray-700/50 mt-12 pt-8 text-center">
          <p className="text-gray-500">© 2026 react-lzy-img. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
