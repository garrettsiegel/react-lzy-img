...
export const CSS_CLASSES = {
  ...
  // LazyPicture component classes
  LAZY_PICTURE: {
    WRAPPER: 'LazyPicture-wrapper',
    PLACEHOLDER: 'LazyPicture-placeholder',
    IMAGE: 'LazyPicture-img',
    FALLBACK: 'LazyPicture-fallback',
    FADE: 'LazyPicture-fade',
  },
